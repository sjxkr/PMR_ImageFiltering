...
void smooth(vector<vector<Pixel> >& image, char userFilename[]);		//shahir to create
void sharpen(vector<vector<Pixel> >& image, char userFilename[]);	//shahir to create
void edgeDetection(vector<vector<Pixel> >& image, char userFilename[]);		//shahir to create
